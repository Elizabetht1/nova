...
MODAL_FINETUNE_ID = "your-finetune-id"  # replace with your finetune id
...
LAST_SCENARIO_PATH = here / "last_scenario.txt"
...
def generate_scenario(task_setting: str = Form(...), task_complexity: str = Form(...), cognitive_load: str = Form(...)):
    ...
    video_bytes = generator.run(prompt, num_frames=75)

    scenario_path = here / "scenario.mp4"
    scenario_path.write_bytes(video_bytes)
